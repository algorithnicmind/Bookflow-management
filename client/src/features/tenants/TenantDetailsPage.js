...
/**
 * Tenant Details / Provisioning Page
 * -----------------------------------
 * Accessible only to Platform Owners. Loads a single onboarding application
 * and allows approve, reject, delete, editing notes, and changing plans.
 */
...
export default function TenantDetailsPage() {
  ...
  return (
    <div className="page-container">
      ...
      <div className="page-header animate-in">
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: 16 }}>
          <div>
            ...
            <h1 className="page-title">{app?.company_name || 'Tenant Details'}</h1>
            <p className="page-subtitle">Manage provisioning for this onboarding application</p>
          </div>
          {app && (
            <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
              ...
              <Button variant="secondary" onClick={() => router.push(`/tenants/${applicationId}/dashboard`)}>
                <AppleEmoji char="📊" /> Dashboard
              </Button>
              <Button
                variant="danger"
      ...
      {isLoading ? (
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
            ...
            <Card>
              <h3 style={{ fontSize: '1rem', fontWeight: 700, marginBottom: 16, display: 'flex', alignItems: 'center', gap: 8 }}>
                <AppleEmoji char="📝" /> Internal CRM Notes
              </h3>
              <textarea
                value={notes}
      ...
      {/* Delete Modal */}
      <Modal isOpen={deleteModal} onClose={() => setDeleteModal(false)} title="Delete Tenant">
